...
exports.ItemsControllers = {
    create: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        let outcome = yield new items_services_1.ItemsService(req).create();
    ...
    read: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        let outcome = yield new items_services_1.ItemsService(req).read();
        if (typeof outcome === "string") {
            res.status(400).json({ error: outcome });
        }
        return res.status(200).json(outcome);
    ...
    readAll: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        let outcome = yield new items_services_1.ItemsService(req).readAll();
        if (typeof outcome === "string") {
            res.status(400).json({ error: outcome });
        }
        return res.status(200).json(outcome);
    ...
    update: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        let outcome = yield new items_services_1.ItemsService(req).update();
        if (typeof outcome === "string") {
            res.status(400).json({ error: outcome });
        }
        return res.status(200).json(outcome);
